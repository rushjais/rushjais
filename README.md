...
**vaudit**: does an RL grader accept work that is correct but different?
[![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white)](#) [![NumPy](https://img.shields.io/badge/NumPy-013243?style=flat&logo=numpy&logoColor=white)](#) [![pytest](https://img.shields.io/badge/pytest-0A9EDC?style=flat&logo=pytest&logoColor=white)](#) [![CI](https://github.com/rushjais/verifier-audit/actions/workflows/check.yml/badge.svg)](https://github.com/rushjais/verifier-audit/actions/workflows/check.yml) [![Sole author](https://img.shields.io/badge/Sole%20author%20%C2%B7%20solo%20continuation%20of%20Goodhart-1f6feb?style=flat)](#) [![Write-up](https://img.shields.io/badge/Write--up-2ea043?style=flat)](https://rushiljaiswal.com/graders) [![Repository](https://img.shields.io/badge/Repository-6e40c9?style=flat&logo=github&logoColor=white)](https://github.com/rushjais/verifier-audit)
🎯 Five CHIP-8 ROMs, each isolating one documented platform quirk, each with its expected frames and falsifiers registered *before the bytes existed*. Three of five published grading strategies rank a **blank screen above a correct implementation**, because two real conventions disagree about one instruction and the glyph lands four pixels apart. Both are right.
🧪 The follow-up study falsified **four of its own predictions**, including my own algebra, and bounded the failure in closed form at `φ(1−d) > ½`. At realistic GBA density with one displaced sprite the effect disappears, and the write-up says so in those words because I had pre-committed to saying it.
🐛 Seven third-party interpreters as the population, adjudicated by the test ROM's own pass/fail marks rather than by agreement with mine. Six bug reports filed upstream and a pull request that takes one interpreter from 8 failures to 0. Twenty occasions where this project's own measurements were about the wrong thing are logged with traced causes.
